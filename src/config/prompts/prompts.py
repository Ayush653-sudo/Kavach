...
class Prompts:
    ...
    PASSWORD_IN_USE = "your entered password is already in use {} times among most common password list"
    ...
    def load(cls) -> None:
        ...
        with open(AppConfig.PROMPT_PATH, "r") as file:
            ...
            cls.PASSWORD_UPDATED_SUCESSFULLY = "PASSWORD UPDATED SUCESSFULLY"
            cls.PASSWORD_DELETED_SUCCESSFULLY = "PASSWORD DELETED SUCCESSFULLY"
            cls.PASSWORD_ADDED_SUCCESSFULLY = "PASSWORD ADDED SUCCESSFULLY"
            ...
            cls.ADMIN_DASHBOARD = data["ADMIN_DASHBOARD"]
